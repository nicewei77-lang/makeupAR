...
- E7 lip-first pre-AR boundary calibration Phase 0: complete for documentation/routing only. Next step is Phase 1-3 buildless slice: calibration data contract, synchronized lip capture or reuse, and one-frame round-trip preparation.
