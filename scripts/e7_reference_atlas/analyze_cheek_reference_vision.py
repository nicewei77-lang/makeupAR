...
SHAPE_ORDER = (
    ("daily", "cheek-session-mask-1-v1"),
    ("lovely", "cheek-session-mask-2-v1"),
    ("under_eye", "cheek-session-mask-3-v1"),
    ("sunkissed1", "cheek-session-mask-4-v1"),
    ("sunkissed2", "cheek-session-mask-5-v1"),
)
